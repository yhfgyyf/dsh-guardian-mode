...
- Preserve the main session's chosen model, effort, and permissions. Guardian is an explicit fifth preset and must not alter Auto Router's original four targets.
