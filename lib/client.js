window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function GuardianDock (props) {
			...
			var stateText = (current.reviewer || "codex") + " · step " + current.completedSteps + " · audits " + current.auditCount + " · " + (remediation ? "repair " + remediation.phase : current.paused ? "paused: " + current.pauseReason : approval ? approval.verdict + " review awaiting approval; agent continues" : "failures " + current.failureCount);
