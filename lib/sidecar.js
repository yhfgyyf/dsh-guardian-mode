 ...
 *
 * The durable rule of the mode: NO audit feedback, summary, verdict, or
 * findings ever enters the DSH session log (the model context). Everything
 * lives here, keyed by session id, in its own directory under the DSH home:
 *
...
export class SidecarStore {
  ...
  async load (sessionId) {
    ...
    return { ...emptyState(sessionId, parsed.createdAt), ...parsed, sessionId }
  }
