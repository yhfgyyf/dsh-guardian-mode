...
7. For a manual or final audit request, your output is that active audit's verdict. The input trace cannot already contain the verdict you are producing, so never require it as evidence or create a finding solely because it is absent.`
