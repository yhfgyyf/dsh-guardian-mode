...
import { CODEX_DEFAULTS } from './codex.js'
...
export const Config = z.object({
  ...
  models: z.object({
    luna: z.object({ model: z.string().default('gpt-5.6-luna'), effort: z.string().default('medium'), provider: z.string().default('') }),
    sol: z.object({ model: z.string().default('gpt-5.6-sol'), effort: z.string().default('max'), provider: z.string().default('') })
...
export class GuardianService extends Service {
  ...
  async snapshot (sessionId) {
    ...
    return engine?.view(state) ?? {
      ...
      models: { luna: this.options.models.luna.model, sol: this.options.models.sol.model },
